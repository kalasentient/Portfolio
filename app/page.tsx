...
export default function AIPortfolio() {
  ...
  const portfolioData = {
    ...
    bio: "Product designer specializing in Gen AI experiences, data informed UX design , and user research. Passionate about creating intuitive interfaces that leverage AI to solve real user problems.",
    contact: {
